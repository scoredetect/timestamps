...
use SDCOM_Timestamps\Vendor_Prefixed\GuzzleHttp\Exception\BadResponseException;
use SDCOM_Timestamps\Vendor_Prefixed\GuzzleHttp\Exception\TooManyRedirectsException;
