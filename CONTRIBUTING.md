...
Open a [new blank issue](https://github.com/scoredetect/timestamps/issues/new) with `[Release] 1.8.0`, then copy and paste the following items, replacing version numbers and links to the milestone.

- [ ] 1. Branch: Starting from `develop`, cut a release branch named `release/1.8.0` for your changes.
...
- [ ] 3. Changelog: Add/update the changelog in `CHANGELOG.md`, ensuring to link the [1.8.0] release reference in the footer of `CHANGELOG.md` (e.g., https://github.com/scoredetect/timestamps/compare/1.8.0-1...1.8.0).
...
1. Branch: Starting from `main`, cut a hotfix release branch named `hotfix/1.8.0` for your hotfix change(s).
...
1. Changelog: Add/update the changelog in `CHANGELOG.md` and `readme.txt`, ensuring to link the [1.8.0] release reference in the footer of `CHANGELOG.md` (e.g., https://github.com/scoredetect/timestamps/compare/1.8.0-1...1.8.0).
